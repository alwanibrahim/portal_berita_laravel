			...
			<div class="card full-height">
				<div class="card-header">
					<div class="card-head-row">
						<div class="card-title">Add materi</div>
                        <a href="{{route('meteri.index')  }}" class="btn btn-warning btn-sm ml-auto"><i class="fas fa-undo"></i></a>
					</div>
				</div>
			    <div class="card-body">
                <form action="{{ route('meteri.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
					<div class="form-group">
                        <label for="judul">materi video</label>
                        <input type="text" class="form-control"   name="judul_materi"   placeholder="Enter materi">
					...
					<div class="form-group">
                        ...
                        <textarea type="text" class="form-control"   name="deskripsi" id="editor" ></textarea>
					...
					<div class="form-group">
                        ...
                        <select  class="form-control"   name="playlist_id" >
                            ...
                            <option value="{{ $apaaja->id }}">{{ $apaaja->judul_playlist }}</option>
                            @endforeach
                        </select>
                        
                    </div>
					<div class="form-group">
                        <label for="gambar">gambar meteri</label>
