			...
			<div class="card full-height">
                ...
                <form action="{{ route('playlist.store')}}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
                        ...
                        <input type="text" class="form-control"   name="judul_playlist"  placeholder="Enter Playlist">
                        
                    </div>
					<div class="form-group">
                        <label for="body">deskripsi</label>
                        <textarea type="text"   class="form-control" id="editor" name="deskripsi"  ></textarea>
